...
**Фабричний метод** виносить `new` у перевизначуваний метод підкласу, щоб клієнт залежав від абстракції продукту, а не від конкретного класу. Практичний C#-приклад створення типу за іменем є в лекції [вбудованих шаблонів](09-builtin-csharp-patterns.md) (`Activator.CreateInstance`).
