...
- Типи значень і посилань
- Приведення типів, boxing / unboxing
- Навіщо generics
- Узагальнені типи, методи, класи та інтерфейси
- Обмеження узагальнень

## Спробуйте самі

- `List<object>` vs `List<int>`: cast і boxing
- Метод обміну значеннями двох змінних
- Калькулятор для різних числових типів
- Шаблонний список (List / LinkedList)
- Колекції як приклад generics; вибір структури — лекція 11
