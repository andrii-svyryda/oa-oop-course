...
- S: відправка email та валідатор адреси
- O: калькулятор площі / знижок
- L: запис у файл із різними форматами
- I: базовий механізм і уточнені інтерфейси
- D: логер Trace / Log / Information / Exception
