...
- Абстракція та моделювання об’єктів
- Інкапсуляція
- Наслідування
- Поліморфізм, upcast / downcast
- Розширювальні методи, делегати, yield, LINQ

## Спробуйте самі

- Абстракції на базі фігур
- Інтерфейси як контракти
- Методи перевантаження
- Інкапсуляція на прикладі банківського рахунку, властивостей і Get/Set
- Абстрактні та віртуальні методи
- Поліморфізм на прикладі класів фігур
- Upcast і downcast
