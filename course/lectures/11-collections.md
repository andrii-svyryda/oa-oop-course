...
- List, Dictionary, HashSet, SortedSet, Stack, Queue

## Спробуйте самі

- Хеш-функція
- Огляд стандартних узагальнених колекцій
...
`List<T>` — типізований список об’єктів із доступом за індексом. На відміну від масиву, розмір змінюється динамічно.
